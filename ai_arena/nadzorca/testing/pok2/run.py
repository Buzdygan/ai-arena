...
bot_lang = 'CPP'
bot2_path = current_dir + "/py_pok_bot.py"
bot2_lang = 'PYTHON'
results = nadzorca.play(judge_file=judge_path, judge_lang='CPP', players=[(bot_path, bot_lang), (bot_path, bot_lang)], time_limit=10, memory_limit=1000000)
