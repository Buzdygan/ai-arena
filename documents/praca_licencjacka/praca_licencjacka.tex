...
\chapter{Wprowadzenie}
    ...
    domen± jest sztuczna inteligencja, w szczególno¶ci jej dzia³, po¶wiêcony inteligentnym
    programom walcz±cym. AI-Arena pozwala równie¿ na przeprowadzanie zawodów w stylu ACM, co sprawia, ¿e oferuje
    ...
    rozwi±zuj±ce problemy w warunkach rywalizacji, jak np. gie³da. Twórcy licz± na to,
    ...
    Projekt jest udostêpniony w serwisie \href{http://github.com/Buzdygan/ai-arena}{Github} na prawach otwartej licencji OpenGPL. 
...
\chapter{Metodologia Pracy}
    ...
    Zdecydowano siê na w³asne rozwi±zanie, inspirowane metodologi± Scrum.
    ...
    koordynowania projektu za pomoc± Redmine'a jest nieproporcjonalnie du¿a i podjêto decyzjê o czê¶ciowym zarzuceniu
    ...
    wyst±pieñ nowych problemów (regresji). W przypadku wyst±pienia regresji mechanizmy kontroli wersji udostêpniane
...
stosowany równie¿ w innych projektach jako oddzielny modu³. Jego podstawow± funkcjonalno¶c stanowi metoda play,
...
\section{Serwis webowy}
    ...
    \begin{enumerate}
        ...
        w celu unikniêcia stronniczych sêdziów. Wwszelkie bowiem nieprawid³owo¶ci
...
\begin{itemize}
    ...
    \item {\bf Bot} - reprezentuje bota graj±cego w konkretn± Grê, zawiera m.in. plik ¼ród³owy i referencjê do pliku wykonywalnego
...
Opiera siê na wzorcu projektowym podobnym do MVC nazywanym MVT. Z tego powodu aplikacjê mo¿na podzieliæ na kilka warstw:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Wa¿ne by³o to, ¿e cz³onkowie zespo³u znali tê technologiê ju¿ wcze¶niej z przedmiotu Aplikacje WWW. Nale¿y zauwa¿yæ, i¿ Django 
          jest proste w u¿yciu, dziêki maksymalnej automatyzacji wielu standardowych procesów (np. renderowania stron WWW).
\end{itemize}
Django powsta³o w celu szybkiego tworzenia standardowych aplikacji internetowych i po do¶wiadczeniach zwi±zanych z tworzeniem projektu
...
nolejnym rozwa¿anym przez autorów systemu rozwi±zaniem by³ program systrace, autorstwa Nielsa Provosa. Systrace jest obecnie zintegrowany do j±dra OpenBSD, mozna go jednak zainstalowaæ jako ³atê do j±dra wielu systemów Unixowych (miêdzy innymi Ubuntu). Nowsze wersje mo¿na równie¿ uruchamiaæ jako program na tych systemach. 
...
u¿ycia. Kluczowym testem okaza³ siê konkurs zorganizowany na pro¶bê $Codility$. Okaza³o siê, ¿e konkurs przebieg³ sprawnie, bez przykrych niespodzianek. Wziê³o udzia³ 14 zawodników
(stan na 25.V), co mo¿na uznaæ za ¶redni sukces zwa¿aj±c na praktycznie zerow± kampaniê reklamow±. Uczestnicy potraktowali udzia³ w konkursie jako rodzaj zabawy, tote¿ nikt nie próbowa³
