...
\begin{itemize}
\item[1)]Pocz±wszy od wersji $8.04$ systemu operacyjnego Ubuntu, AppArmor by³ zosta³ zintegrowany do j±dra systemu. Dziêki temu nie trzeba by³o dokonywaæ zmian w j±drze systemu na serwerze udostêpnionym autorom przez firmê $Codility$.
\item[2)] Tworzenie polityk AppArmor jest intuicyjne. Tworzenie polityk i obs³uga SELinux jest niepomiernie bardziej skomplikowane.
\end{itemize}
