...
\chapter{Wprowadzenie}
    ...
    jest dziedzina sztucznej inteligencji, w szczególno¶ci inteligentnych programów walcz±cych. Od parudziesiêciu
    lat odbywaj± siê zawody, maj±ce na celu wy³oniæ programy najlepiej graj±ce w popularne gry, takie jak
    szachy, warcaby itp. Serwis Ai-Arena pozwala organizowaæ takie konkursy dla dowolnej gry wieloosobowej.
...
\begin{itemize}
	\item{Plik ¼ród³owy sêdziego} 
		...
		gracz graj±cy pionami czarnymi nie ruszy³ siê bia³ym pionem). Gdy upewni siê, ¿e otrzymany komunikat jest poprawny wysy³a na swoje standardowe wyj¶cie komunikat zgodnie z formatem opisanym 
		w regu³ach gry.
	...
	\item{Plik z zasadami rozgrywki}
		Plik ten musi zawieraæ ogólny opis gry (np. fabu³ê wprowadzaj±c±) oraz szczegó³owy opis i znaczenie komunikatów. W szczególno¶ci musz± byæ zawarte informacje takie jak:
		\begin{itemize}
