...
\chapter{Metodologia Pracy}
    ...
    ¯adna z pocz±tkowo rozwa¿anych metodologii nie spe³nia³a wszystkich powy¿szych wymagañ. Zdecydowano siê wiêc na modyfikacjê metodologii Scrum.
    ...
    Sprinty trwaj± zazwyczaj kilka tygodni. W tym przypadku by³ to tydzieñ
    ...
    by³ minutkami i trzymany w systemie Google Documents, tak by ka¿dy z cz³onków zespo³u oraz prowadz±cy
    ...
    Z uwagi na ma³± liczno¶æ zespo³u zdecydowano siê nie u¿ywac narzêdzi wspomagaj±cych ¶ledzenie zmian. Do obowi±zków
    ...
    Czêste spotkania projektowe umo¿liwi³y cz³onkom zespo³u pozostanie na bie¿±co z aktualnymi zmianami. W czasie takich spotkañ,
...
\section{Rozpoznanie problemu}
    ...
    Sztuczna inteligencja jest wspó³cze¶nie bardzo modn± dziedzin± informatyki. Znajduje zastosowania w kolejnych ga³êziach 
    informatyki i nie tylko. Nic wiêc dziwnego, ¿e coraz wiêcej osób wyra¿a zainteresowanie t± dziedzin± informatyki, jednocze¶nie
    pragn±c pog³êbiaæ swoj± wiedzê w tym zakresie. Potrzeba ta nie jest jednak w pe³ni zaspokojona. W internecie istnieje wiele platform wspieraj±cych
...
\section{Grupa docelowa}
    ...
    Definiuje to w pewnym sensie sposób wykonania projektu. Mo¿na siê spodziewaæ, ¿e czê¶æ tej grupy, zafasynowana równie¿ bezpieczeñstwem
...
\section{Nadzorca}
    ...
    protoko³em. Nadzorca odbiera wynik Meczu od Sêdziego i przekazuje go do narzêdzia zwanego Gearman, w celu zapisania rezultatu w bazie.
...
\begin{figure}[!ht]
    \begin{center}
    \makebox[\textwidth]{
        \includegraphics[width=1.25\textwidth]{img/contests_uml.png}
    }
    \end{center}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1.0\textwidth]{img/UseCaseDiagram.jpg}
    \end{center}
...
wszystkie pliki zwi±zane z gr± do nowych lokalizacji. U¿ytkownik musi jednak zadbaæ, aby nowa nazwa gry by³a unikalna. W przeciwnym razie próba edycji
zakoñczy siê pora¿k±.
\vspace{1cm}
...
W dalszej czê¶ci rozdzia³u zobaczymy wykresy obrazuj±ce podzia³ prac miêdzy poszczególne zagadnienia zwi±zane z rozwojem projektu takie jak
...
Spotkania projektowe oznaczaj± tutaj spotkania zespo³u, w czasie których omawiana by³a wizja projektu czy bie¿±cy podzia³ prac. Administracja 
...
W pierwszej fazie projektu skupiono siê na kluczowych zagadnieniach maj±cych wp³yw na ostateczny wygl±d serwisu. Powsta³y wtedy m.in. takie
